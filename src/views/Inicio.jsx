            ...
            */}
            ...
            <div className='mx-2 flex flex-col  flex-1 '>
                ...
                <div className=' flex  flex-col '>
                    ...
                    <Link to='/carta' className='text-center bg-primary px-4 py-4 border-[3px] border-accent rounded-lg text-2xl mt-6 text-accent shadow-lg font-bold mb-4'>Ir al Menú</Link>
                    {
                        lang === 'es' ?
                            <>
                    ...
                    <div className='mb-6 flex justify-between items-center mt-6 '>
                        <Link to='https://g.page/r/CZXnwFuuEQLiEBM/review' target='_blank' className='bg-red-700 rounded-lg px-4 py-2 text-white font-bold shadow-lg flex items-center justify-start'>
                            <p className='mr-1'>Calificanos en google :) </p><FaGooglePlusSquare className='text-2xl' />
                        </Link>
                        <div className='flex '>
